#!/bin/bash
#SBATCH --job-name=all_Neig32tn4096ny4096
#SBATCH --array=0-47                      # Adjust this automatically based on how many jobs you calculate
#SBATCH --time=7-00:00:00
#SBATCH --mem=128G
#SBATCH --cpus-per-task=3
#SBATCH --output=logs_Neig32tn4096ny4096/%x_%A_%a.out
#SBATCH --error=logs_Neig32tn4096ny4096/%x_%A_%a.err
#SBATCH --mail-user=doyeon.k@unb.ca
#SBATCH --mail-type=ALL

# Make sure SLURM can write its own logs:
mkdir -p logs_Neig32tn4096ny4096
...
OUT_DIR="results_Neig32tn4096ny4096/${MODE}/mx${MX}_my${MY}"
mkdir -p "$OUT_DIR"
